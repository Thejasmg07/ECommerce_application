...
const List = ({ token }) => {
  ...
  return (
    <>
      <p className='mb-2 text-[30px]'>All Products List</p>
      <div>
        {/* List Table Title */}
        <div className='hidden md:grid grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center py-3 px-2 border border-gray-300 bg-gray-100 text-sm' >
          <b>Image</b>
          <b>Name</b>
          <b>Category</b>
          <b>Price</b>
